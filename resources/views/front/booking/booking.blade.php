    ...
    <div class="men">
        <div class="container">
            <div class="col-md-12 register">
                <h3 class="text-center text-success">Welcome to booking process. You have to login to complete your valuable booking. If you are not registered then please register first. Thanks.</h3>
                <hr/>
